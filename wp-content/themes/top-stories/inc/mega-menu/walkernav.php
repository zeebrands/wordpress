...
namespace top_stories;

use Walker_Nav_Menu;

class Top_Stories_Walkernav extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        if( isset( $args->has_children ) && !$args->has_children && ( ( $child_cats && $hasMegaMenu_subcat ) || ( $hasMegaMenu && $mm_posts_query ) && $depth == 0 ) ) {
            ...
            $item_output .= '<span class="icon">'.top_stories_theme_svg('chevron-down',true).'</span>';
        ...
        $item_output .= ( ( $depth == 0 || 1 ) && $has_children ) ? '<span class="icon">'.top_stories_theme_svg('chevron-down',true).'</span></a>' : '</a>';
            ...
            if( ( $child_cats && $hasMegaMenu_subcat ) || ( $hasMegaMenu && $mm_posts_query ) ){
                ...
                if( $hasMegaMenu_subcat && $child_cats ){
                    ...
                    foreach( $child_cats as $child_cat ){
                        ...
                        $output .= '<span class="icon">'.top_stories_theme_svg('chevron-right',true).'</span>';
                        $output .= '</a>';
                        $output .= '</div>';
