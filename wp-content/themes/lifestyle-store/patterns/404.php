...
<h2 class="has-text-align-center has-primary-color has-text-color" style="font-size:160px;letter-spacing:15px;line-height:1"><?php esc_html_e('404','lifestyle-store'); ?></h2>
<!-- /wp:heading -->
